from hapi2.profiling import tic, toc, tictoc
...
@tictoc('Calculate grid indices and grid alignments',SETTINGS['DEBUG'])
...
@tictoc('Calculate lineshape distribution matrix',SETTINGS['DEBUG'])
...
## Apply transform:
@tictoc('Apply transform',SETTINGS['DEBUG'])
...
## Synthesize spectrum:
@tictoc('Synthesize spectrum',SETTINGS['DEBUG'])
